...
using SoMRandomizer.gui.Properties;
...
namespace SoMRandomizer.gui.forms
{
    ...
    public partial class CharacterDesigner : Form
    {
        ...
        private void reDraw()
        {
            ...
            {
                case 0:
                    newBitmap = new Bitmap(Resources.sprite_boy);
                    defaultPalette = boyDefault;
                    currentPalette = boyCurrent;
                    break;
                case 1:
                    newBitmap = new Bitmap(Resources.sprite_girl);
                    defaultPalette = girlDefault;
                    currentPalette = girlCurrent;
                    break;
                case 2:
                    newBitmap = new Bitmap(Resources.sprite_sprite);
            ...
            {
                case 2:
                    bgBitmap = new Bitmap(Resources.backdrop_forest);
                    break;
                case 3:
                    bgBitmap = new Bitmap(Resources.backdrop_cave);
                    break;
                case 4:
                    bgBitmap = new Bitmap(Resources.backdrop_ruins);
                    break;
                case 5:
                    bgBitmap = new Bitmap(Resources.backdrop_castle);
                    break;
            }
